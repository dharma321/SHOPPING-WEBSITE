...
<html>
    ...
    <body>
                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
						<th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th><th><a href="address.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm your Address</a></th>

                        </tr>
						
                    </tbody>
                </table>
				<form method="POST" action="php-paytm/pgRedirect.php">
						<tr>
						<label for="">  Order ID</label>
						<input id="ORDER_ID"  name="ORDER_ID" value="<?php echo "OD".rand(10000,500000) ?>" /></tr>
						<tr>
						<label for=""> -- Customer ID</label>
						<input  id="CUST_ID" name="CUST_ID" value="CUST001"/></tr>
						<tr>
						<label for="">-- Transaction Amount</label>
						<input  id="TXN_AMOUNT" name="TXN_AMOUNT" value="<?php echo $sum;?>" /></tr>
						<br><br>
						<center>
     ...
     <br>                </center>
			...
			<br> <br><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Confirm with COD</a></th>
						      <br> <br>  <a href="index1.php" role="button" class="btn btn-primary ">Feedback</a></center>	
